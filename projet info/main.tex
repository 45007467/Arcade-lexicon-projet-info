...
\membrea{NOM Prénom  N étudiant : XXXXXXXX}
\membreb{NOM Prénom  N étudiant : XXXXXXXX}
\membrec{NOM Prénom  N étudiant : XXXXXXXX}
\membred{NOM Prénom  N étudiant : XXXXXXXX}
\membree{NOM Prénom  N étudiant : XXXXXXXX}
% 
...
\url{https://github.com/VOTRE_COMPTE/arcade-lexicon}
...
\hline
[Membre 1] & Conception du projet, choix des jeux, tests, rédaction du rapport \\
\hline
[Membre 2] & Direction créative, choix du design, tests des jeux d'arcade \\
\hline
[Membre 3] & Spécifications des fonctionnalités IA, validation des résultats \\
\hline
[Membre 4] & Tests et débogage, rédaction des sections techniques \\
\hline
[Membre 5] & Mise en page LaTeX, captures d'écran, documentation \\
\hline
Claude (IA) & Génération du code HTML/CSS/JS, algorithmes de jeux, intégration API \\
\hline
\end{tabular}
